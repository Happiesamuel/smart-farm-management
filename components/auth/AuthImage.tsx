...
const managements = [
  {
    icon: <RiTimer2Line />,
    text: "Track farm activities in real-time",
  },
  {
    icon: <AiOutlineTeam />,
    text: "Manage your team and tasks",
  },
  {
    icon: <CgInsights />,
    text: "Make better decisions with insights",
  },
];
      ...
      <div className="relative aspect-auto w-full h-full flex items-center justify-center ">
        ...
        <div className="z-20 p-6 flex flex-col justify-between absolute h-full w-full">
          ...
          <div className="space-y-4">
            <p className="bg-[#60a10a] text-white w-fit text-xs px-3 rounded-full p-1">
              For Farm Owners
            </p>
            <h2 className="text-white text-2xl sm:text-4xl font-semibold">
              Manage your farm,
              <br /> growing <span className="text-[#9ed457]">everywhere.</span>
            </h2>
            <p className="text-sm sm:text-base text-white max-w-full sm:max-w-[380px] font-normal">
              S.F.M.S helps farm owners manage their farms, crops, team, tasks
              and finances - all in one smart platform.
            </p>
          </div>
          <div className="flex flex-col  gap-3 ">
            {managements.map((b) => (
              ...
              >
                <div className="text-xl bg-[#1d441d] rounded-md size-8 flex items-center justify-center text-white">
                  {b.icon}
                </div>
