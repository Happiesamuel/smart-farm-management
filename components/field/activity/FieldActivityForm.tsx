...
export default function FieldActivityForm() {
  ...
  const activityTypes = [
    { value: "started", name: "Task Started" },
    { value: "completed", name: "Task Completed" },
    { value: "note", name: "Note" },
    { value: "photo", name: "Photo Upload" },
  ];
  const arrField = [
    {
      value: "fieldA",
      ...
      <Form {...form}>
        ...
        >
          ...
          <div className="flex gap-4 md:gap-6 items-center flex-col md:flex-row justify-between">
            <ActivityInput
              label="Task name"
              placeholder="Task name (e.g Irrigate Field A)"
              name="taskName"
              control={form.control}
            />
            <ActivitySelect
