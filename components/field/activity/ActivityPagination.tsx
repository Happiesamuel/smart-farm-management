...
export default function ActivityPagination() {
  return (
    <div className="flex items-center justify-between px-2.5 py-3 text-sm text-dark/80 mt-4 border border-border/80 shadow-xs hover:shadow-sm transition bg-white gap-1">
