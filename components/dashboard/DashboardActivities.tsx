...
export default function DashboardActivities() {
  return (
    <div className="flex-[0.75]">
      <h6 className="text-lg pb-2 font-semibold text-dark">Smart Alerts</h6>

      <div className="space-y-3">
        {/* FIELD ACTIVITIES */}
        <div className="bg-green-50 border border-green-200 p-3 rounded-lg hover:shadow-sm transition">
        ...
        {/* RECENT ACTIVITIES */}
        <div className="bg-blue-50 border border-blue-200 p-3 rounded-lg hover:shadow-sm transition">
          <div className="flex items-center justify-between">
            <div>
        ...
        {/* UPCOMING HARVEST */}
        <div className="bg-yellow-50 border border-yellow-200 p-3 rounded-lg hover:shadow-sm transition">
          <div className="flex items-center justify-between">
            <div>
