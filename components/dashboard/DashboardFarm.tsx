...
export default function DashboardFarm() {
  ...
  return (
    <div className="flex-[0.75] size-ful aspect-video  bg-white relative  rounded-xl border border-border/80 shadow shadow-dark/10 flex flex-col h-[300px] shrink-0">
      ...
      <Image src={Img} className="size-full rounded-xl" fill alt="farm" />
    </div>
  );
}
